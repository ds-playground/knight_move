"""
Knight's Tour Path Analysis Script

This script analyzes knight move paths on a 4x5 grid containing letters and numbers.
It finds valid paths that avoid missing positions and limits visits to vowel locations.

The analysis includes:
- Creating a DataFrame with letters A-O and numbers 1-3
- Identifying vowel positions and missing/empty positions
- Generating knight move paths with constraints
- Counting total valid paths across all starting positions
"""

# Import required modules for data creation and path analysis
...
if __name__ == "__main__":
    ...
    # =================================================================
    # STEP 2: Define path validation criteria
    # =================================================================
    ...
    # =================================================================
    # STEP 3: Generate and count valid knight move paths
    # =================================================================
    ...
    print(f"Analyzing {step_i}-move knight paths from all starting positions...")
    ...
    for x_i in range(x_min, x_max + 1):
        ...
        for y_i in range(y_min, y_max + 1):
            ...
            # Generate all valid knight move paths from position (x_i, y_i)
            # Constraints applied:
            ...
            if len(all_path_list) > 0:
                print(f"  Starting position ({x_i},{y_i}): {len(all_path_list)} valid paths")
